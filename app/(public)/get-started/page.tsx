...
export default function UploadHomePage() {
  ...
  const onDrop = useCallback((acceptedFiles: File[]) => {
    ...
    if (file && file.type === "application/pdf") {
      ...
      // Redirigir a la página de login para que el usuario inicie sesión/registre antes de analizar
  ...
  return (
  <div className="container-levely bg-white dark:bg-transparent relative h-full overflow-hidden">
      {/* Blobs decorativos */}
      ...
      <div className="container mx-auto px-4 py-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-2xl mx-auto">
          <div className="text-center mb-8">
            ...
            <h1 className="text-4xl font-bold text-gray-800 dark:text-gray-100 mb-4">Sube tu CV</h1>
            <p className="text-xl text-gray-600 dark:text-gray-300">Analiza y mejora tu CV existente con nuestra IA avanzada</p>
          </div>

          <Card className="shadow-xl border-0 bg-white/90 dark:bg-gray-800/60 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="text-center text-2xl text-gray-800 dark:text-gray-100">Selecciona tu archivo PDF</CardTitle>
            </CardHeader>
            <CardContent>
              {!uploadedFile ? (
                <div
                  ...
                  className={`border-2 border-dashed rounded-lg p-12 text-center cursor-pointer transition-colors ${
                    isDragActive
                      ...
                      : "border-gray-300 dark:border-gray-700 hover:border-orange-400 hover:bg-orange-50 dark:hover:bg-orange-900/20"
                  }`}
                >
                  <input {...getInputProps()} />
                  <Upload className="w-16 h-16 text-gray-400 dark:text-gray-300 mx-auto mb-4" />
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">Solo archivos PDF (máximo 5MB)</p>
                </div>
              ) : (
                <motion.div
                ...
                >
                  <div className="flex items-center justify-center p-6 bg-green-50 dark:bg-green-900/20 rounded-lg">
                    ...
                    <div>
                      <h3 className="font-semibold text-green-800 dark:text-green-200">Archivo cargado exitosamente</h3>
                  ...
                  <div className="flex gap-4">
                    ...
                    <Button variant="outline"
                            ...
                            className="px-6 cursor-pointer dark:border-gray-600 dark:text-gray-200">
                      Cambiar
                    </Button>
                  </div>
                </motion.div>
        ...
        <section className="max-w-6xl mx-auto px-6 py-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <Card className="bg-white/90 dark:bg-gray-800/60 backdrop-blur-sm shadow-lg border-0 p-6">
                <CardContent className="flex flex-col items-center space-y-3">
                  <BarChart3 className="w-10 h-10 text-purple-500 dark:text-purple-300" />
                  <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100">Análisis Detallado</h3>
            ...
            >
              <Card className="bg-white/90 dark:bg-gray-800/60 backdrop-blur-sm shadow-lg border-0 p-6">
                <CardContent className="flex flex-col items-center space-y-3">
                  ...
                  <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100">Recomendaciones Profesionales</h3>
                  <p className="text-gray-600 dark:text-gray-300 text-sm">
            ...
            >
              <Card className="bg-white/90 dark:bg-gray-800/60 backdrop-blur-sm shadow-lg border-0 p-6">
                <CardContent className="flex flex-col items-center space-y-3">
                  ...
                  <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100">Datos Seguros</h3>
                  <p className="text-gray-600 dark:text-gray-300 text-sm">
