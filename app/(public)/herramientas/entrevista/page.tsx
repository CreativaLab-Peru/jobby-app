...
import { EntrevistaMockup } from "@/components/ui/app/public/herramientas/entrevista-mockup";

export default function SimuladorEntrevistas() {
  const features = [
    {
      icon: Mic2,
      title: "Voz real en inglés",
      description: "El entrevistador habla como el comité real. Tú respondes en voz. La IA transcribe y evalúa.",
    },
    {
      icon: Star,
      title: "STAR + Learning",
      description: "Score por Situación, Tarea, Acción, Resultado y Aprendizaje — el estándar de Chevening y Fulbright.",
    },
    {
      icon: ClipboardList,
      title: "Reporte detallado",
      description: "Score por pregunta, mejora concreta para cada respuesta y PDF descargable al finalizar.",
    },
  ];
      ...
      <>
          ...
          <div className="container-levely relative">
            <div className="max-w-3xl mx-auto text-center space-y-6">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground tracking-tight leading-[1.1] max-w-2xl mx-auto">
                Practica tu entrevista <br />
                <span className="text-primary font-italic italic">antes del día real.</span>
              </h1>

              <p className="text-lg text-muted-foreground leading-relaxed max-w-xl mx-auto">
                Un entrevistador IA con voz real hace las preguntas exactas que usa Chevening, Fulbright y DAAD. <strong className="text-foreground font-semibold">Feedback instantáneo con el método STAR + Learning.</strong>
              </p>
        ...
        <section className="section-padding bg-primary/10 border-t border-primary/20 text-center relative overflow-hidden">
          ...
          <div className="container-levely relative space-y-6 max-w-2xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground">Domina tu entrevista internacional</h2>
            <p className="text-muted-foreground text-base leading-relaxed">Pierde el miedo y practica con respuestas evaluadas en tiempo real por nuestro agente inteligente.</p>
            <div className="pt-2">
              <Link href="/onboarding/talents">
