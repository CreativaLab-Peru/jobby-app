...
import { RadarMockup } from "@/components/ui/app/public/herramientas/radar-mockup";
  ...
  const features = [
    {
      ...
      description: "El agente revisa +20 fuentes internacionales continuamente. Tú no tienes que buscar.",
    },
    {
      icon: Languages,
      title: "Traducción automática",
      description: "Todo en inglés → traducido al español con contexto. Nunca más perderás una convocatoria por el idioma.",
    },
    {
      icon: Target,
      title: "Filtrado por tu perfil",
      description: "Solo ves convocatorias relevantes para tu área, nivel y país. Sin ruido.",
    },
  ];
      ...
      <>
          ...
          <div className="container-levely relative">
            <div className="max-w-3xl mx-auto text-center space-y-6">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/10 border border-primary/20">
                <RadarIcon className="w-3.5 h-3.5 text-primary animate-pulse" />
                <span className="text-[10px] font-bold text-primary uppercase tracking-wider">
                  Radar de oportunidades
                </span>
                <span className="px-2 py-0.5 rounded-full bg-accent/20 text-accent text-[9px] font-bold uppercase tracking-wider">
                  Nuevo
                </span>
              </div>

              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground tracking-tight leading-[1.1] max-w-2xl mx-auto">
                Las convocatorias del mundo <br />
                <span className="text-primary font-italic italic">en español, en tiempo real.</span>
              </h1>

              <p className="text-lg text-muted-foreground leading-relaxed max-w-xl mx-auto">
                El agente monitorea embajadas, ministerios y boletines internacionales en inglés. <strong className="text-foreground font-semibold">Las traduce, filtra las relevantes para ti y las agrega a tu match automáticamente.</strong>
              </p>
        ...
        <section className="section-padding bg-primary/10 border-t border-primary/20 text-center relative overflow-hidden">
          ...
          <div className="container-levely relative space-y-6 max-w-2xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground">No dejes pasar ninguna convocatoria</h2>
            <p className="text-muted-foreground text-base leading-relaxed">El radar inteligente hace el trabajo pesado por ti, detectando y traduciendo en tiempo real.</p>
            <div className="pt-2">
              <Link href="/onboarding/talents">
