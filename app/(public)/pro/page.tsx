  ...
  return (
    <PublicPageTransition>
      <>
        <div className="min-h-screen">
            ...
            <div className="container mx-auto max-w-6xl relative z-10">
              <div className="text-center space-y-8 animate-fade-in">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-4">
                  ...
                  <span className="text-sm font-medium text-primary">Plan más popular</span>
                </div>
                ...
                <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                  CV optimizado con IA, hasta 5 CV creados y guardados, y recomendaciones de
                  vacantes hechas a tu medida.
                </p>
          ...
          <section className="relative py-24 px-4 sm:px-6 lg:px-8 bg-card/30 overflow-hidden">
            ...
            <div className="pointer-events-none absolute inset-0">
              <div className="absolute left-1/2 top-0 -translate-x-1/2 h-96 w-96 rounded-full bg-primary/20 blur-3xl opacity-30" />
            </div>
            ...
            <div className="relative container mx-auto max-w-6xl">
              ...
              <div className="relative grid md:grid-cols-3 gap-8 lg:gap-12">
                {/* Línea conectora */}
                <div className="hidden md:block absolute top-16 left-0 right-0 h-px bg-gradient-to-r from-transparent via-primary/40 to-transparent" />
          ...
          <section className="py-20 px-4 sm:px-6 lg:px-8 relative">
            <div className="container mx-auto max-w-6xl">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                  Descubre lo fácil que es crear un CV profesional con nuestra plataforma
                </p>
              </div>
          ...
          <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-card/30 to-background">
            <div className="container mx-auto max-w-6xl">
              <div className="text-center mb-16">
                <h2 className="text-3xl sm:text-5xl font-bold mb-4">
                  ¿Por qué elegir <span className="text-gradient">Levely PRO?</span>
                </h2>
                <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                ...
                <Card className="p-8 bg-card shadow-lg hover:shadow-xl transition-all duration-300 border-2 border-border/50 relative overflow-hidden group opacity-90">
                  ...
                  <h3 className="text-2xl font-bold mb-2 text-muted-foreground">Otras opciones</h3>
                  <p className="text-sm text-muted-foreground mb-6">Métodos tradicionales</p>
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start gap-3 text-muted-foreground">
                      ...
                      <span>
                        Asesorías tradicionales: S/200 - S/300 por una sola revisión. de CV.
                      </span>
                    </li>
                    <li className="flex items-start gap-3 text-muted-foreground">
                      <div className="mt-1">
                      ...
                      <span>Suscripciones mensuales en plataformas.</span>
                    </li>
                    <li className="flex items-start gap-3 text-muted-foreground">
                      <div className="mt-1">
                        <CheckCircle2 className="h-5 w-5 text-muted-foreground/60 shrink-0" />
                    ...
                    <li className="flex items-start gap-3 text-muted-foreground">
                      ...
                      <span>No siempre adaptadas al talento joven o al mercado local.</span>
                    </li>
                  </ul>
                </Card>
                ...
                <Card className="p-8 bg-gradient-to-br from-primary/10 via-secondary/5 to-accent/10 shadow-2xl hover:shadow-glow transition-all duration-300 hover:scale-[1.02] border-2 border-primary/50 relative overflow-hidden group">
                  ...
                  <div className="flex items-baseline gap-2 mb-6">
                    <span className="text-3xl font-bold text-primary">Pago único de S/9.90</span>
                  </div>
                  ...
                  <ul className="space-y-4">
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <span className="text-base">
                        <span className="text-foreground">
                          Recomendaciones de oportunidades ajustadas a tu perfil según tus
                          habilidades.
                        </span>
                      </span>
                    </li>
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <span className="text-base">
                        <span className="text-foreground">Score de match.</span>
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="mt-1">
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <span className="text-base">
                        <span className="text-foreground">Exportación: PDF y Word.</span>
                      </span>
                    </li>
                  </ul>
        ...
        <EmailModal isOpen={isOpen} closeModal={closeModal} />
      </>
    </PublicPageTransition>
  );
};
