...
export default function Resources() {
  return (
    <>
      {/* Hero */}
      <section className="py-20 section-padding bg-levely-dark text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-levely-green/10 text-levely-green text-sm font-medium mb-6">
              <Download className="w-4 h-4 text-levely-green" />
              Recursos gratuitos
            </div>
            ...
            <p className="text-lg sm:text-xl text-muted-foreground mb-8">
              Templates, dashboards y guías diseñadas para ayudarte a organizar tu búsqueda laboral
