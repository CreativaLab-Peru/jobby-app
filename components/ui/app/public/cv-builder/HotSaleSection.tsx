...
export function HotSaleSection() {
  return (
    <section className="section-padding bg-gradient-to-br from-levely-green/20 via-levely-from-levely-green/10 to-background relative overflow-hidden">
      {/* Background decoration */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-10 left-10 w-32 h-32 bg-levely-green/20 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-10 right-10 w-48 h-48 bg-levely-green/15 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "1s" }} />
      ...
      <div className="container-levely relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-10">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-levely-green text-levely-dark text-sm font-bold mb-6 animate-pulse">
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center mt-4">
                ...
                <div className="space-y-4">
                  {features.map((feature, index) => (
                    ...
                    >
                      <div className="w-6 h-6 rounded-full bg-levely-green flex items-center justify-center flex-shrink-0 mt-0.5">
