...
- `seekingTypes` se define en el siguiente paso del onboarding y se guarda en `CompanyPreference`.
...
- `STEP_1`: datos básicos de la empresa (`Company`).
- `STEP_2`: qué busca la empresa (`CompanyPreference.seekingTypes`).
