...
interface AdminCvEvaluationPromptRowProps {
...
export function AdminCvEvaluationPromptRow({ prompt }: AdminCvEvaluationPromptRowProps) {
      ...
      <Card className="rounded-xl border border-border/60 p-4">
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div className="space-y-1">
            ...
            <div className="text-xs text-muted-foreground">{truncateText(prompt.prompt)}</div>
