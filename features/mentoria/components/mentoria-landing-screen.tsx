...
const CheckIcon = () => (
  <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
...
const MENTORIA_FEATURES = [
  { emoji: "🔍", title: "Revisión humana de tu perfil", body: "Analizamos tu experiencia, formación y metas para identificar exactamente qué becas aplican a tu caso." },
  { emoji: "🎓", title: "Las becas reales que existen para vos", body: "Identificamos cuáles aplican a tu caso específico y por qué." },
  { emoji: "🗺️", title: "Tus 10 mejores universidades UK", body: "Seleccionadas en sesión según tu área y perfil académico." },
  { emoji: "⚙️", title: "Cómo funciona el proceso — de verdad", body: "Qué documentos piden, en qué orden, qué fechas importan." },
  { emoji: "✉️", title: "Cartas y ensayos: qué piden y cómo enfocarlos", body: "Revisamos cuáles documentos necesitás y cómo estructurar cada uno." },
  { emoji: "💬", title: "Grupo privado de WhatsApp", body: "Acceso exclusivo al grupo de asesorados Levely para resolver dudas." },
];
...
export function MentoriaLandingScreen({ onStart, requestStatus }: MentoriaLandingScreenProps) {
  ...
  return (
    ...
    >
      {/* ── Nav ── */}
      <nav className="flex justify-between items-center px-6 md:px-12 py-[18px] border-b border-white/[.06] bg-[#0a0f0c]">
        <span
      ...
      <section className="bg-[#0a0f0c] px-6 md:px-12 pt-10 md:pt-16 pb-14">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-[15px] leading-[1.65] text-[rgba(240,237,228,.55)] max-w-xl mb-10">
            Sesión personalizada con <strong className="text-[rgba(240,237,228,.85)] font-medium">Dara Mariluz</strong>, fundadora de Levely. Alguien que ya pasó por el proceso y sabe exactamente qué necesitas para ganar.
          </p>
      ...
      <section className="bg-[#2ecdf] px-6 md:px-12 py-14 md:py-20">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-[15px] leading-[1.6] text-[rgba(10,15,12,.6)] mb-8 max-w-xl">
            La mentoría no es para todos. Es para quienes ya tienen algo que mostrar — y solo necesitan que alguien les diga qué hacer con ello.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            {PARA_QUIEN_BULLETS.map((bullet) => (
              <div key={bullet} className="flex items-start gap-3 text-[14px] text-[rgba(10,15,12,.75)]">
          ...
          <div className="bg-[#0a0f0c] text-[#f0ede4] rounded-2xl p-5 md:p-6">
            ...
            <p className="text-[14px] text-[rgba(240,237,228,.65)]">
              Tener al menos un CV básico o experiencia laboral/proyectos demostrables. No necesitas hablar perfecto inglés — necesitas saber qué becas existen para tu perfil.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {MENTORIA_FEATURES.map(({ emoji, title, body }) => (
              <div key={title} className="bg-white border border-[rgba(10,15,12,.08)] rounded-2xl p-5">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-start">
            ...
            <div className="flex-shrink-0">
              <div className="w-28 h-28 md:w-36 md:h-36 rounded-full bg-[#c9f563]/20 border-2 border-[#c9f563]/40 flex items-center justify-center">
            ...
            <div className="flex-1">
              ...
              <p className="text-[14px] leading-[1.7] text-[rgba(240,237,228,.6)] mb-6 max-w-xl">
                Dara fundó Levely después de pasar por el proceso completo de aplicación a becas internacionales. Conoce las preguntas que nadie te hace antes de que sea demasiado tarde, y sabe exactamente qué buscan los committees de selección porque lo ha vivido en primera persona.
              </p>
              ...
              <div className="flex flex-col gap-2">
                {[
                  ...
                  <div key={cred} className="flex items-center gap-2 text-[13px] text-[rgba(240,237,228,.55)]">
                    <CheckIcon />
                    {cred}
                  </div>
                ))}
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {MENTORIA_TESTIMONIALS.map(({ quote, name, location, badge }) => (
              <div key={name} className="bg-white border border-[rgba(10,15,12,.08)] rounded-2xl p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[11px] px-3 py-1 bg-[#c9f563]/10 text-[#0a0f0c] rounded-full font-medium">
                    {badge}
                  </span>
                </div>
              </div>
      ...
      <section className="bg-[#f2ecdf] px-6 md:px-12 pb-14 md:pb-20 pt-10 sm:pt-16">
        <div className="max-w-5xl mx-auto flex flex-col items-center text-center">
          <p className="text-[11px] font-semibold tracking-[.1em] uppercase text-[rgba(10,15,12,.4)] mb-4">
            Inversión
          </p>
          ...
          <p className="text-[14px] text-[rgba(10,15,12,.6)] max-w-md mb-8 leading-[1.6]">
            Una sesión de 60 minutos te ahorra meses de investigación incorrecta. Si aplicas a Chevening, la beca cubre matrícula, vuelo y estipendio — más de $80k USD. S/ 250 es menos del 0.1% de eso.
          </p>
      ...
      <footer className="bg-[#0a0f0c] border-t border-white/[.06] px-6 md:px-12 py-6">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-[11px] text-[rgba(240,237,228,.25)]">
          <span className="text-[#c9f563] font-semibold">levely</span>
          <div className="flex items-center gap-4">
            <a href="/politica-de-privacidad" className="hover:text-[rgba(240,237,228,.5)] transition-colors">
