...
export default function AnalysisResultsScreen({ initialData, score, id }: AnalysisResultsScreenProps) {
    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <Card className="p-8 rounded-[2.5rem] border-border/50 shadow-xl bg-card">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm font-bold text-muted-foreground uppercase tracking-tight">Score de Empleabilidad</p>
          ...
          <Badge variant="secondary" className="rounded-full px-4 py-2 bg-secondary text-secondary-foreground border-none gap-2 font-bold shadow-sm">
      ...
      <div className="space-y-8 pt-10">
        <div className="flex flex-col items-center gap-2">
          <h2 className="text-2xl font-black tracking-tight text-center">Oportunidades que hacen Match</h2>
          <div className="h-1 w-12 bg-primary rounded-full" />
        </div>

        {/* Simulación de contenido bloqueado */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 opacity-50 select-none pointer-events-none grayscale blur-[1px]">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <Card key={i} className="p-8 rounded-[2rem] border-dashed border-2 border-border flex flex-col items-center justify-center gap-4 bg-secondary/20">
        ...
        <Card className="p-12 rounded-[3.5rem] bg-secondary/40 border border-border/40 flex flex-col items-center text-center space-y-8 relative overflow-hidden">
          ...
          <div className="space-y-3">
            ...
            <p className="text-muted-foreground max-w-sm font-medium">
              Desbloquea el reporte completo para acceder a recomendaciones personalizadas y el match de oportunidades.
            </p>
          </div>
